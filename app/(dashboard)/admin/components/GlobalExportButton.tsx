...
export default function GlobalExportButton() {
  ...
  return (
    <button
      ...
      disabled={loading}
      className="group flex items-center gap-2 px-5 py-2.5 bg-blue-600 text-white text-sm font-semibold rounded-lg hover:bg-blue-700 transition-all disabled:opacity-50"
    >
      {loading ? (
        <>
