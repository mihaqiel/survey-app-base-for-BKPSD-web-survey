...
export default function DeleteConfirmModal({ layananId, layananNama, totalCount }: Props) {
  ...
  return (
    <>
      {/* TRIGGER */}
      <div className="bg-white rounded-xl border border-red-100 shadow-sm p-5 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
        <div>
          <p className="text-sm font-semibold text-slate-900 mb-1">Hapus Semua Data Respon</p>
        ...
        <button onClick={() => setStep("pin")}
          className="group px-5 py-2.5 bg-red-600 text-white text-sm font-semibold rounded-lg hover:bg-red-700 transition-all shrink-0">
          ...
          <div className="bg-white w-full max-w-md rounded-xl overflow-hidden shadow-2xl">
            ...
            <div className="px-6 py-5 flex flex-col gap-4">
              <div className="bg-red-50 border border-red-100 rounded-lg p-3">
                <p className="text-xs font-semibold text-red-600 mb-1">Data yang akan dihapus:</p>
                ...
                <div className="space-y-3">
                  ...
                  <div>
                    ...
                    {phrase.length > 0 && !isPhraseConfirmed && (
                      <p className="text-xs text-amber-600 mt-1.5">Ketik tepat: HAPUS (huruf kapital semua)</p>
                    )}
                  </div>
                </div>
              )}
