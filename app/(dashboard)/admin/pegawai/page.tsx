import { getAllLayanan, createLayanan } from "@/app/action/admin";
            ...
            <div className="p-8 space-y-6">
              ...
              <div className="border-t border-white/10 pt-6 space-y-4">
                ...
                {[
                  ...
                  "Untuk menghapus layanan, gunakan menu Hapus Data Survei di sidebar.",
    ...
    <div className="min-h-screen font-sans bg-[#F0F4F8]">
      <div className="bg-white border-b border-gray-200 px-8 py-5 flex items-center justify-between">
        ...
        <div className="flex items-center gap-3">
          ...
          <Link href="/admin/hapus-data?tab=layanan"
            className="px-4 py-2 bg-red-50 border border-red-200 text-red-500 text-[10px] font-black uppercase tracking-widest hover:bg-red-500 hover:text-white transition-colors">
            🗑 Hapus Data
          </Link>
