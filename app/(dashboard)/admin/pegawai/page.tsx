  ...
  return (
    <div className="flex items-center gap-1">
      ...
      <button
        ...
        className="w-7 h-7 flex items-center justify-center border border-gray-200 text-gray-400 hover:bg-[#132B4F] hover:text-white hover:border-[#132B4F] disabled:opacity-25 disabled:cursor-not-allowed transition-all"
      >
      ...
      {Array.from({ length: total }).map((_, i) => (
        <button
          ...
          className={`w-7 h-7 text-[9px] font-black transition-all ${
            i === page
            ...
            {pageEmployees.length === 0 ? (
              ...
              return (
                <button
                  ...
                  aria-label={`Pilih pegawai ${emp.nama}`}
