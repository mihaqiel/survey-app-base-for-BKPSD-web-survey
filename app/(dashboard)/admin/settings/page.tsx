...
import { ArrowLeft, Activity, AlertTriangle, BarChart3, Layers, Users, QrCode } from "lucide-react";
  ...
  return (
    <div className="min-h-screen font-sans bg-[#F0F4F8]">
      ...
      <div className="animate-fade-down bg-white border-b border-gray-200 px-8 py-5 flex items-center justify-between shadow-sm">
        ...
        <Link href="/admin"
          className="btn-shimmer group flex items-center gap-1.5 px-4 py-2 bg-white border border-gray-200 text-[#132B4F] text-[10px] font-black uppercase tracking-widest hover:bg-[#F0F4F8] hover:scale-[1.02] transition-all duration-200 active:scale-[0.98] animate-slide-right">
