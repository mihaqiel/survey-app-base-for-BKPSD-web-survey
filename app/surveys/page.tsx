    ...
    <div className="p-10 text-white max-w-3xl mx-auto">
      ...
      <form action={createDynamicSurvey} className="space-y-6">
        ...
        <div className="space-y-4">
          {questions.map((q, i) => (
            <div key={i} className="flex gap-4 items-start p-4 bg-gray-900 border border-gray-800 rounded-lg">
              <div className="flex-1 space-y-2">
                <input 
                  ...
                  required 
                />
                <select name="qType" className="w-full p-2 bg-gray-800 rounded border border-gray-700 text-blue-400">
                  <option value="TEXT">Text Explanation</option>
                  <option value="SCORE">Score / Rating (1-10)</option>
                </select>
              </div>
              <button 
                type="button" 
