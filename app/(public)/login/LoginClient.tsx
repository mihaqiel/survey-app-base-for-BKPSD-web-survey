...
const ERROR_MESSAGES: Record<string, string> = {
  ...
  ConfigError:       "Metode ini tidak tersedia saat ini. Gunakan username dan password.",
};
              ...
              <div>
                <div className="flex items-center justify-between mb-2">
                  <label
                    htmlFor="l-password"
                    className={labelClass()}
                    style={{ color: "rgba(255,255,255,0.45)", marginBottom: 0 }}
                  >
                    Password
                  </label>
                  <a
                    href="mailto:bkpsdm@anambaskab.go.id?subject=Reset%20Password%20Dashboard"
                    className="text-[10px] font-semibold tracking-wide transition-colors"
                    style={{ color: "rgba(255,255,255,0.35)" }}
                    onMouseEnter={(e) => { e.currentTarget.style.color = "rgba(250,231,5,0.8)"; }}
