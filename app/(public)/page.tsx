        ...
        <div className="relative max-w-5xl mx-auto px-6 py-20 md:py-28">
          <div className="max-w-3xl">
            ...
            <div className="animate-fade-up delay-300 flex flex-col sm:flex-row gap-3">
              <Link href="/enter?token=global-token-2026"
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-0 border border-gray-200">
          {[
            ...
            <div key={f.title}
              ...
              <div className="w-10 h-10 flex items-center justify-center mb-5 transition-transform duration-200 hover:scale-110"
        ...
        <div className="max-w-5xl mx-auto px-6 py-16 w-full">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-px bg-gray-200">
            {[
              ...
              { step: "03", icon: <ClipboardList className="w-6 h-6 text-[#009CC5]" />, title: "Isi Formulir",     desc: "Isi data diri dan berikan penilaian terhadap 9 unsur kepuasan pelayanan." },
              ...
              <div key={item.step} className="bg-white p-7 group card-hover animate-fade-up"
